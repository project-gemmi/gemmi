...
void add_meta(nb::module_& m) {
  ...
  nb::bind_vector<std::vector<NcsOp>>(m, "NcsOpList");
  ...
  nb::bind_vector<std::vector<Entity>>(m, "EntityList");
  ...
  nb::bind_vector<std::vector<Connection>>(m, "ConnectionList");
  ...
  nb::bind_vector<std::vector<Helix>>(m, "HelixList");
  ...
  nb::bind_vector<std::vector<Sheet::Strand>>(sheet, "StrandList");

  sheet
    .def(nb::init<std::string>())
    .def_rw("name", &Sheet::name)
    .def_rw("strands", &Sheet::strands);
  nb::bind_vector<std::vector<Sheet>>(m, "SheetList");
  ...
  nb::bind_vector<std::vector<Assembly::Operator>>(assembly, "OperatorList");
  ...
  nb::bind_vector<std::vector<Assembly::Gen>>(assembly, "GenList");
  ...
  assembly
    ...
    ;
  nb::bind_vector<std::vector<Assembly>>(m, "AssemblyList");
