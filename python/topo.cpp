...
void add_topo(nb::module_& m) {
  ...
  nb::class_<Topo::Bond>(topo, "Bond")
    ...
    ;
  nb::bind_vector<std::vector<Topo::Bond>>(m, "TopoBonds");
  ...
  nb::class_<Topo::Angle>(topo, "Angle")
    ...
    ;
  nb::bind_vector<std::vector<Topo::Angle>>(m, "TopoAngles");
  ...
  nb::class_<Topo::Torsion>(topo, "Torsion")
    ...
    ;
  nb::bind_vector<std::vector<Topo::Torsion>>(m, "TopoTorsions");
  ...
  nb::class_<Topo::Chirality>(topo, "Chirality")
    ...
    ;
  nb::bind_vector<std::vector<Topo::Chirality>>(m, "TopoChirs");
  ...
  nb::class_<Topo::Plane>(topo, "Plane")
    ...
    ;
  nb::bind_vector<std::vector<Topo::Plane>>(m, "TopoPlanes");
  ...
  nb::class_<Topo::Rule>(topo, "Rule")
    ...
    ;
  nb::bind_vector<std::vector<Topo::Rule>>(m, "TopoRules");
  ...
  nb::class_<Topo::Link>(topo, "Link")
    ...
    ;
  nb::bind_vector<std::vector<Topo::Link>>(m, "TopoLinks");
  ...
  nb::class_<Topo::ResInfo>(topo, "ResInfo")
    ...
    ;
  nb::bind_vector<std::vector<Topo::ResInfo>>(m, "TopoResInfos");
