...
void add_chemcomp(nb::module_& m) {
  ...
  nb::bind_vector<std::vector<Restraints::Bond>>(m, "RestraintsBonds");
  nb::bind_vector<std::vector<Restraints::Angle>>(m, "RestraintsAngles");
  nb::bind_vector<std::vector<Restraints::Torsion>>(m, "RestraintsTorsions");
  nb::bind_vector<std::vector<Restraints::Chirality>>(m, "RestraintsChirs");
  nb::bind_vector<std::vector<Restraints::Plane>>(m, "RestraintsPlanes");
  nb::bind_vector<std::vector<ChemComp::Atom>>(m, "ChemCompAtoms");
  ...
  chemcompatom
    .def_ro("id", &ChemComp::Atom::id)
    .def_ro("el", &ChemComp::Atom::el)
    .def_ro("charge", &ChemComp::Atom::charge)
    .def_ro("chem_type", &ChemComp::Atom::chem_type)
