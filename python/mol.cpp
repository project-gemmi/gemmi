...
auto default_make_iterator(const S&, T& value) {
  return nb::make_iterator(nb::type<S>(), "iterator", value);
}
...
void add_mol(nb::module_& m) {
  ...
  nb::class_<CraProxy>(m, "CraGenerator")
    .def("__iter__", [](CraProxy& self) {
        return default_make_iterator(self, self);
    }, nb::keep_alive<0, 1>());
  ...
  structure
    ...
    .def("__iter__", [](const Structure& st) {
        return default_make_iterator(st, st.models);
    }, nb::keep_alive<0, 1>())
  ...
  pyModel
    ...
    .def("__iter__", [](Model& self) {
        return default_make_iterator(self, self.chains);
    }, nb::keep_alive<0, 1>())
    ...
    .def("count_atom_sites", &count_atom_sites<Model>, nb::arg("sel")=nullptr)
    // deprecated, use has_hydrogen() or count_atom_sites(Selection('[H,D]'))
    .def("count_hydrogen_sites", &count_hydrogen_sites<Model>)
    .def("count_occupancies", &count_occupancies<Model>, nb::arg("sel")=nullptr)
  ...
  pyChain
    ...
    .def("__iter__", [](const Chain& ch) {
        return default_make_iterator(ch, ch.residues);
    }, nb::keep_alive<0, 1>())
    ...
    .def("count_atom_sites", &count_atom_sites<Chain>, nb::arg("sel")=nullptr)
    .def("count_occupancies", &count_occupancies<Chain>, nb::arg("sel")=nullptr)
  ...
  pyResidueSpan
    ...
    .def("__iter__", [](ResidueSpan& g) { return default_make_iterator(g, g); },
         nb::keep_alive<0, 1>())
  ...
  nb::class_<AtomGroup>(m, "AtomGroup")
    ...
    .def("__iter__", [](AtomGroup& g) { return default_make_iterator(g, g); },
         nb::keep_alive<0, 1>())
  ...
  pyResidue
    ...
    .def("__iter__", [](const Residue& res) {
        return default_make_iterator(res, res.atoms);
    }, nb::keep_alive<0, 1>())
