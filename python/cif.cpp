...
void add_cif(nb::module_& cif) {
  ...
  nb::class_<Document>(cif, "Document")
    ...
    .def("__iter__", [](const Document& d) {
        return nb::make_iterator(nb::type<Document>(), "iterator", d.blocks);
    }, nb::keep_alive<0, 1>())
  ...
  cif_block
    ...
    .def("__iter__", [](Block& self) {
        return nb::make_iterator(nb::type<Block>(), "iterator", self.items);
    }, nb::keep_alive<0, 1>())
  ...
  cif_column
    ...
    .def("__iter__", [](const Column& self) {
        return nb::make_iterator(nb::type<Column>(), "iterator", self);
    }, nb::keep_alive<0, 1>())
  ...
  cif_table_row
    ...
    .def("__iter__", [](const Table::Row& self) {
        return nb::make_iterator(nb::type<Table::Row>(), "iterator", self);
    }, nb::keep_alive<0, 1>())
